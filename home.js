(() => {
  ...
  "hero.kicker": "Right AI 2.0 · Browser Intelligence Hub",
  ...
  "zh-Hant": {
    ...
    "panels.quick.2": "支援智慧建議、意圖預測與快速送出。",
    ...
    "footer.back": "回到頂部 ↑",
    "hero.kicker": "Right AI 2.0 · 瀏覽器智慧中樞",
  ...
  "ja": {
    ...
    "panels.quick.2": "スマート提案、意図予測、高速送信をサポート。",
    ...
    "footer.back": "トップへ ↑",
    "hero.kicker": "Right AI 2.0 · ブラウザインテリジェンスハブ",
  ...
  "ko": {
    ...
    "panels.quick.2": "스마트 제안, 의도 예측, 빠른 전송을 지원합니다.",
    ...
    "footer.back": "맨 위로 ↑",
    "hero.kicker": "Right AI 2.0 · 브라우저 인텔리전스 허브",
  ...
  "ru": {
    ...
    "panels.quick.2": "Поддерживает умные подсказки, предсказание намерений и быструю отправку.",
    ...
    "footer.back": "Наверх ↑",
    "hero.kicker": "Right AI 2.0 · Интеллектуальный хаб в браузере",
